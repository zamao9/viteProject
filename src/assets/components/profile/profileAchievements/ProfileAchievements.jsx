...
const ProfileAchievements = () => {
	const achieveData = [
		...
		{ key: 3, svg: Game, headline: 'The Keeper', description: 'Save 1000 V-Cash', progress: 56 },
		{ key: 4, svg: Game, headline: 'The Keeper', description: 'Save 1000 V-Cash', progress: 100 },
	];
